...
# earlystop_cb = EarlyStopping(monitor='val_loss', min_delta=0, patience=2, verbose=0, mode='auto')
...
history = model.fit(xtrain_pad, y=ytrain_enc, validation_data=(xvalid_pad, yvalid_enc), batch_size=64, epochs=100, verbose=1, shuffle=True, callbacks=[check_cb], initial_epoch=initial_epoch) # earlystop_cb
